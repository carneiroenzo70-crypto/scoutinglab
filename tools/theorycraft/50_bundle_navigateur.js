/* Assemble le moteur pour le NAVIGATEUR → assets/theorycraft.js
   ...
   produit en phase avec les 430 vérifications du moteur.

   Sortie : un seul fichier statique, chargé À LA DEMANDE par app.html (~840 Ko brut,
...
const bundle = `/* VisionScore — moteur de theorycraft, version navigateur.
   ...
   c'est ce qui garantit que le produit et les 430 vérifications parlent du même code.
